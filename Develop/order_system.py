def place_order(menu):
    ...
    while True:
        ...
        menu_selcetion = input("Please enter the menu item number you wish to purchase.")

        # TODO: Update the order list using the update_order function
        update_order(order, menu_selcetion, menu_items)
        ...
        more_order = input("Would you like to order anything else? (Type 'n' or 'N' to quit):")
        if more_order.lower() == 'n':
